...
# create config file
 ...
 GraphThresholdHigh="100"
 echo	    " Enter graphr range high % (default 90-100): $(($(echo $GraphThresholdMid | cut -d "-" -f2) +1 ))-100"
 ...
 for i in FSLocalSystems FSLocalStorage FSRemote FrameColor ColumnHeaderColor SortFSColumnSystem SortFSColumnStorage SortFSColumnRemote \
	  GraphThresholdLow GraphThresholdMid GraphThresholdHigh GraphRangeLow GraphRangeMid GraphRangeHigh GraphRoundValue \
 GraphColorLow GraphColorMid GraphColorHigh; do
