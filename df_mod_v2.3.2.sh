...
# Konfigurierbare Maximal-Längen
MaxDeviceLength=30      # Spalte 1: Device / Mountquelle
MaxMountpointLength=30  # Spalte 7: Mountpoint (meist länger → mehr Platz)
...
load_processing_vars () {
    ...
    # Defaultwerte falls nicht in Config
    : ${MaxDeviceLength:=40}
    : ${MaxMountpointLength:=60}
    ...
    # Hilfsfunktion: Kürzt nur Device (Spalte 1) und Mountpoint (Spalte 7)
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------
# changelog
# 2.3.2  add MaxDeviceLength= + MaxMountpointLength=
